...
from .types import (ALLOC_TABLE_TYPE, CURRENT_VERSION, FieldDescType,
                    HeaderType, get_handlers, get_metadata_type)
...
class Reader:
    ...
    def read_field_descriptors(self):
        ...
        field_descriptors = np.fromfile(
            self._fname, dtype=FieldDescType, count=self.num_fields, offset=offset
        )
